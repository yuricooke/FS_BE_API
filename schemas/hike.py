...
class HikeSchema(BaseModel):
    ...
    imageUrl: str = (
        "https://www.nps.gov/yose/planyourvisit/images/20170719_yose_001.jpg"
    )
    difficulty: int = 3
    duration: int = 3
    distance: int = 10
    ...
    rating: int = 5
    explained: str = (
        "America's Yosemite National Park is a treasure trove of granite cliffs, waterfalls, and giant sequoias. Trails like the Mist Trail lead to iconic landmarks such as Yosemite Falls and Half Dome, offering hikers unparalleled views of the park's stunning landscapes."
    )
    lat: float = 37.8651
    lng: float = -119.5383
